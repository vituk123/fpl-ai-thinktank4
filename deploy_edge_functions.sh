...
echo "  → Deploying ml-report function..."
supabase functions deploy ml-report --no-verify-jwt
...
echo "  - ML Report: https://YOUR_PROJECT.supabase.co/functions/v1/ml-report"
...
echo "  supabase functions serve ml-report"
