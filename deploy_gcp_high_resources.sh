#!/bin/bash
# Deploy FPL Backend to Google Cloud Run with HIGH RESOURCES
# Use this after quota increases are approved
...
echo "🚀 Deploying FPL Backend to Google Cloud Run (HIGH RESOURCES)..."
echo "   Project: ${PROJECT_ID}"
echo "   Region: ${REGION}"
echo "   Service: ${SERVICE_NAME}"
echo "   Memory: 32Gi (8x increase)"
echo "   CPU: 8 (4x increase)"
echo ""
...
# Deploy to Cloud Run with HIGH RESOURCES
echo "🚀 Deploying to Cloud Run with high resources..."
