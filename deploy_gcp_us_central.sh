#!/bin/bash
# Deploy FPL Backend to Google Cloud Run in US Central (may have higher quotas)

set -e

PROJECT_ID="instant-vent-481016-c0"
SERVICE_NAME="fpl-api-backend"
REGION="us-central1"  # US Central region - often has higher quotas
IMAGE_NAME="gcr.io/${PROJECT_ID}/${SERVICE_NAME}"

echo "🚀 Deploying FPL Backend to Google Cloud Run (US Central)..."
echo "   Project: ${PROJECT_ID}"
echo "   Region: ${REGION} (may have higher quotas)"
